...
//        Notify.show(Tag.notifyMsg());
        ...
        List<String> typeNames = Arrays.asList(Tag.categoryMsg(), "动作片", "爱情片", "科幻片", "恐怖片", "剧情片", "战争片", "纪录片", "动画片", "国剧", "日韩剧", "欧美剧");
    ...
    public String detailContent(List<String> ids) throws Exception {
        ...
        vod.put("vod_content", Tag.prefixMsg()+description);
        if (playMap.size() > 0) {
            vod.put("vod_play_from", Tag.prefixMsg()+TextUtils.join("$$$", playMap.keySet()));
